...
FIXTURE_ROOT = ROOT.join("real_fixtures")
...
requested = ARGV
fixtures = FIXTURE_ROOT.children.select(&:directory?).sort
fixtures.select! { |fixture| requested.include?(fixture.basename.to_s) } unless requested.empty?
abort "No matching real fixtures" if fixtures.empty?
