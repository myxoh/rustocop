...
The 89 cops in `intentionally_pending_cops.yml` have had their cop spec files
...
`2026-08-23T12:32:23-04:00`: all 24,089 comparable executable cases and all 517 active cops
match RuboCop 1.87.0, including correction expectations. The five restored spec
