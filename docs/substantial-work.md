...
- RuboCop 1.87.0 defines 606 built-in cops. The native registry advertises 563;
  43 non-scalable, incomplete, or reference-blocked implementations are intentionally pending.
