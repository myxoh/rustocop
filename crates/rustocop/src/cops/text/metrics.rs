...
fn check_metrics(lines: &[SourceLine], options: &InspectionConfig, offenses: &mut Vec<Offense>) {
...
fn check_abc_size(lines: &[SourceLine], options: &InspectionConfig, offenses: &mut Vec<Offense>) {
